...
const team = [
  { name: "Annie Pursel", role: "Founder & Stylist", accent: "bg-rose-400", instagram: "#", bookUrl: "/book", bio: "Passionate about creating beautiful transformations." },
  { name: "Stylist Two", role: "Senior Stylist", accent: "bg-violet-400", instagram: "#", bookUrl: "/book", bio: "Specializing in modern cuts and styles." },
  { name: "Stylist Three", role: "Color Specialist", accent: "bg-emerald-400", instagram: "#", bookUrl: "/book", bio: "Expert in balayage and color corrections." },
  { name: "Stylist Four", role: "Stylist", accent: "bg-amber-400", instagram: "#", bookUrl: "/book", bio: "Creative styling for every occasion." },
];
